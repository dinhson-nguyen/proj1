...
namespace _qt_qml_content_Screen02_ui_0x2e_qml { 
    extern const unsigned char qmlData[];
    extern const QQmlPrivate::AOTCompiledFunction aotBuiltFunctions[];
    const QQmlPrivate::CachedQmlUnit unit = {
        reinterpret_cast<const QV4::CompiledData::Unit*>(&qmlData), &aotBuiltFunctions[0], nullptr
...
namespace _qt_qml_content_Screen03_ui_0x2e_qml { 
    extern const unsigned char qmlData[];
    extern const QQmlPrivate::AOTCompiledFunction aotBuiltFunctions[];
    const QQmlPrivate::CachedQmlUnit unit = {
        reinterpret_cast<const QV4::CompiledData::Unit*>(&qmlData), &aotBuiltFunctions[0], nullptr
...
Registry::Registry() {
    ...
    resourcePathToCachedUnit.insert(QStringLiteral("/qt/qml/content/Screen02.ui.qml"), &QmlCacheGeneratedCode::_qt_qml_content_Screen02_ui_0x2e_qml::unit);
    resourcePathToCachedUnit.insert(QStringLiteral("/qt/qml/content/Screen03.ui.qml"), &QmlCacheGeneratedCode::_qt_qml_content_Screen03_ui_0x2e_qml::unit);
